...
def _get_smtp_config() -> dict[str, str]:
    ...
    username = _strip_env_quotes(os.getenv("GMAIL_SMTP_USER") or os.getenv("SMTP_USERNAME", ""))
    password = _strip_env_quotes(
        os.getenv("GMAIL_APP_PASSWORD") or os.getenv("SMTP_PASSWORD", "")
    )
